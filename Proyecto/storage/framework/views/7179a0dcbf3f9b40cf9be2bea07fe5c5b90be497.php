...
<body>
    ...
    <nav class="menuPrincipalNavegando">
        <div class="menuPrincipal4">
            <a href="<?php echo e(route('homeAdmin')); ?>" class="menu1">
            ...
            <a href="<?php echo e(route('adminTematicas')); ?>">
                <img src="../../img/controlador-de-gamepad 1.png" alt="">
                Temáticas
            </a>
            <a href="<?php echo e(route('uploadCromos')); ?>">
                <img src="../../img/cloud-solid 1.png" alt="">
                Cromos
            </a>
            <a href="<?php echo e(route('uploadPreguntas')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\aplicaciones\proyectoIntegrador\laravel\Proyect\resources\views/layouts/appAdmin.blade.php ENDPATH**/ ?>